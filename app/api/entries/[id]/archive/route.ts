...
import { archiveEntry } from "@/lib/content/entryService";
...
export async function POST(req: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  const result = await archiveEntry({ workspaceId: auth.data!.actor.workspaceId, entryId: id, actorAdminUserId: auth.data!.actor.adminUserId });
